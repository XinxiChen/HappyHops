...
INSERT INTO salesforce.product2 (name, bartender__ids, image__c, location, location__latitude__s, location__longitude__s, open__hours, description)  VALUES
  ...
  ('Society','{4}','https://s3-us-west-2.amazonaws.com/happyhops/bars/bar4.jpg','10 E 21st, New York, NY 10011','40.739885','-73.990082','11AM-4AM','An underground pool hall with 19 billiards tables, a full bar, leagues & dozens of TVs.');
